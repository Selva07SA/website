const footerLinks = {
  Products: [
    { label: "CRM Software", target: "products" },
    { label: "Billing Software", target: "products" },
    { label: "Inventory Management", target: "products" },
  ],
  Services: [
    { label: "Web Development", target: "services" },
    { label: "Mobile Apps", target: "services" },
    { label: "Custom Software", target: "services" },
  ],
  Company: [
    { label: "About", target: "whychooseus" },
...
const Footer = () => {
  ...
  return (
    <footer className="border-t border-border py-20 bg-[#BFC6C4]">
