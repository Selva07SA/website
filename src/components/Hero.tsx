      ...
      <div className="section-container pb-12 md:pb-20 relative w-full">
        <div>
          ...
          >
            ...
            <h1 className="font-heading text-5xl md:text-6xl lg:text-7xl font-light tracking-tight text-foreground leading-[1.1] min-h-[3.5em] md:min-h-[2.5em]">
              {displayText}
            ...
            >
              Problem builds scalable SaaS products and custom digital solutions for modern businesses.
            </motion.p>
